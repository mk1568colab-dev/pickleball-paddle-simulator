...
NPD_REQUIRED_INVESTMENT_BASE = 10_000.0
NPD_SEGMENT_COST_MULTIPLIERS: dict[str, float] = {
    "premium": 1.25,
    "mid": 1.00,
    "beginner": 0.85,
}
NPD_TECH_GENERATION_COST_MULTIPLIERS: dict[int, float] = {
    1: 0.80,
    2: 1.00,
    3: 1.35,
    4: 1.75,
}
NPD_DEMAND_FIT_AMBITION_COST_RATE = 0.30
NPD_DEFECT_IMPROVEMENT_COST_RATE = 12.0
NPD_ESTIMATE_LOW_MULTIPLIER_BY_TECH_GENERATION: dict[int, float] = {
    1: 0.90,
    2: 0.90,
    3: 0.92,
    4: 0.95,
}
NPD_ESTIMATE_HIGH_MULTIPLIER_BY_TECH_GENERATION: dict[int, float] = {
    1: 1.10,
    2: 1.15,
    3: 1.25,
    4: 1.45,
}
NPD_TESTING_ADEQUACY_LOW_THRESHOLD = 0.35
NPD_TESTING_ADEQUACY_GOOD_THRESHOLD = 0.70
...
READINESS_INVESTMENT_SCALE = 93.0
READINESS_INVESTMENT_RATE = 1.8
READINESS_TESTING_BONUS_MAX = 18.0
READINESS_COMPLEXITY_PENALTY_PER_TECH = 2.8
LAUNCH_READINESS_THRESHOLD = 84.0
NPD_EXPEDITE_PROGRESS_THRESHOLD = 0.85
NPD_EXPEDITE_TESTING_THRESHOLD = 0.65
NPD_EXPEDITE_EXTRA_PROGRESS_PER_ROUND = 0.65
NPD_MAX_EXPEDITE_ROUND_REDUCTION_BY_TECH_GENERATION: dict[int, int] = {
    1: 0,
    2: 0,
    3: 1,
    4: 1,
